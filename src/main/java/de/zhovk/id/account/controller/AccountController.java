...
import de.zhovk.id.account.service.IAccountService;
...
public class AccountController {
	...
	public ResponseEntity<ApiResponse<AccountResponse>> getAccount(@PathVariable UUID id) {
		...
		return ResponseEntity.ok(ApiResponse.success(response, "Account found successfully", "/api/v1/account/" + id));
	}
	...
	public ResponseEntity<ApiResponse<AccountResponse>> createAccount(@RequestBody CreateAccountRequest request) {
		...
		return ResponseEntity.ok(ApiResponse.success(response, "Account created succesfully", "/api/v1/account"));
	...
	public ResponseEntity<ApiResponse<AccountResponse>> updateAccount(@PathVariable UUID id,
		...
		return ResponseEntity
				.ok(ApiResponse.success(response, "Account updated successfully", "/api/v1/account/" + id));
	}
